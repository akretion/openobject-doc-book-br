 ...
 *Agora que você descobriu algumas das muitas possibilidades de OpenERP de uma turnê do banco de dados de demonstração, você irá desenvolver um caso real. Um banco de dados vazio proporciona o ponto de partida para testar um fluxo de trabalho clássico de vendas de produtos para compra, completar a sua visita guiada e se familiarizar com seu OpenERP.*
